# react-native-in-apps-reviews [![npm](https://img.shields.io/npm/v/react-native-in-apps-reviews.svg)](https://www.npmjs.com/package/react-native-in-apps-reviews)
...
```sh
$ npm install react-native-in-apps-reviews
...
```sh
$ yarn add react-native-in-apps-reviews
```
...
Run `react-native link react-native-in-apps-reviews` to link the react-native-in-apps-reviews library.
after following the instructions for your platform to link react-native-in-apps-reviews into your project:
...
```ruby
 pod 'react-native-in-apps-reviews', :path => '../node_modules/react-native-in-apps-reviews'
```
...
```gradle
include ':react-native-in-apps-reviews'
project(':react-native-in-apps-reviews').projectDir = new File(rootProject.projectDir, '../node_modules/react-native-in-apps-reviews/android')
```
...
dependencies {
   ...
+    implementation project(':react-native-in-apps-reviews')
}
```
...
```java
import com.winplaybox.inappsreviews.AppReviewPackage;
```
...
```javascript
import InAppReview from 'react-native-in-apps-reviews';
```
...
```js
// __mocks__/react-native-in-apps-reviews.js
